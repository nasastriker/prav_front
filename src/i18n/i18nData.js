...
export default {
  ru: {
        Faq:'Faq',
      Soft:'Шаблоны сообщений',
      check:'Чеки',
      HelpPage: 'Помощь',
      Reestr:'Реестры',
      Request:'Обращения заемщиков',
      Setting:'Настройки',
      fnsArhiv:'Скачать архив',
      fnsWork:'Работа с ФНС',
      fnsAnswer:'Ответы ФНС',
      UserAccess:'Доступы',
      WorkActions:'Рабочие действия',
      uploadFiles:'Загрузка документов',
      TaskUser:'Задачи',
      Sud:'Заявления в суд',
      FileManager:'Файловый менеджер',
      Isk:'Исковое производство',
      import_folder:'Импорт из директории',
      System:'Системное',
      SudAct:'Законы о мировых',
      reestrPochta:'Реестр Почта',
      statistics:'Статистика',
      FNS:'ФНС',
      organization:'Организация',
      JudAct:'Cуды районные',
      TaskUsers:'Задачи пользователей',
      task_status:'Статусы задач',
      SudOrder:'Судебные расходы',
      pfr_arch:'Скачать архив',
      pfr_return:'Отзыв СА ПФР',
      fssp_return:'Отзыв СА ФССП',
      fsspRefine:'Уточнить ФССП',
      bankrot_answer:'Работа Банкротство',
      bankrot_sud:'Заявления в суд',
      Pole:'Поля для отчета',
      Reports:'Отчеты',
      ImpStatus:'Импорт статусов',
      payment_reestr:'Импорт платежей',
      payment_reestr_so:'Импорт судебные расходы',
      bank_answer:'Возвраты Банков',
      Credit:'Займы',
      fsspClaim:'Жалобы ФССП нет ИП',
      fsspClaimVed:'Жалобы ФССП по ведению ИП',
      Ifns:'ИФНС',
      sber_alfa:'Запрос Банки ЭДО',
      fsspArhiv:'Скачать архив',
      fsspWork:'Работа с ФССП',
      fsspAnswer:'Ответы ФССП',
      sber_alfa_sa:'Сопровод Банки ЭДО',
      sber_alfa_return_sa:'Отзыв СА Банки ЭДО',
      other_sa:'Заявление СА другие банки',
      other_return_sa:'Отзыв СА другие банки',
      Analytics:'Аналитика',
      Unloading:'Выгрузка',
      Dogovora:'Договора уступки',
      Site:'Сайт',
      buhSogl:'Соглашения',
      buhPp:'ПП на оплату',
      Shablon:'Шаблоны документов',
      Task:'Задачи',
      Payment:'Платежи',
      PaymentSo:'Платежи суд расходы',
      bankWork:'Банки',
      Main:'Основные',
      Ogrnprocent:'Ограничение процентов',
      Organization:'Организация',
      Template:'Шаблоны',
      Cession:'Договоры цессии',
      Phone:'Телефон',
      RabProc:'Рабочий процесс',
      refine:'Уточнить подсудность',
      rabsud:'Заявления в суд',
      regmail:'Регистрация входящей почты',
      proceeding:'Исполнительное производство',
      bankrot:'Банкротство',
      buh:'Платежи',
      control:'Контроль рабочего процесса',
      RequestUser:'Запросы пользователей',
      Import:'Импорт реестров',
      Dosud:'Контакты с Должниками',
      SudBlock:'Судебный блок',
      Status:'Статусы',
      TypeDocument:'Типы документов',
      Recoverer:'Взыскатели',
      Jurisdiction:'Подсудность',
      Judicial:'Судебные участки',
      Handbook:'Справочники',
      Debtor:'Реестр Заемщиков',
      Bank:'Банки',
      Pfr:'ПФ РФ',
      Fssp:'ФССП',
      FsspOtdels:'ФССП Отделы',
      RabProf:'РАБОЧИЙ ПРОФИЛЬ',
      MainBlock:'ОСНОВНОЙ БЛОК',
        ...
        eCommerce: 'eCommerce',
        Apps: 'Apps',
        Balance:'История расходов',
        Todo: 'Todo',
        Chat: 'Чат',
        Pay:'Пополнить баланс',
        News:'Новости',
        Document:'Мои документы',
        Email: 'Email',
        Calendar: 'Календарь',
