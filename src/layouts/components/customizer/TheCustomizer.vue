      ...
      <div class="h-full">
        ...
        <component :is="scrollbarTag" class="scroll-area--customizer pt-4 pb-6" :settings="settings" :key="$vs.rtl">
          ...
          <div class="px-6">
            ...
            <div class="mt-4">
              <h5 class="mb-2">Показывать название переменных</h5>
              <div>
                <vs-switch v-model="User.pag.showPer" @input="setDataUser" />
              </div>
            </div>
            <div class="mt-4">
              <h5 class="mb-2">Сортировка по фамилии</h5>
              <div>
                <vs-switch v-model="User.sort_family" @input="setDataUser" />
              </div>
            </div>
            <div class="mt-4">
              <h5 class="mb-2">Показывать настройки в Регистрации Судактов</h5>
              <div>
                <vs-switch v-model="User.pag.showSettingsRegSud" @input="setDataUser" />
              </div>
            </div>

            <div class="mt-4">
              <h5 class="mb-2">Показывать даты ответов банка</h5>
              <div>
                <vs-switch v-model="User.pag.showDateReturn" @input="setDataUser" />
              </div>
            </div>
            <div class="mt-4">
              <h5 class="mb-2">Показывать даты запросов в банк</h5>
              <div>
                <vs-switch v-model="User.pag.showDateSend" @input="setDataUser" />
              </div>
            </div>

            <div class="mt-4">
              <h5 class="mb-2">Показывать доп. графы </h5>
              <div>
                <vs-switch v-model="User.pag.showDopGraf" @input="setDataUser" />
              </div>
            </div>
            <div class="mt-4">
              <h5 class="mb-2">Свободное место </h5>
              <div>
               {{FreeSpace}}Gb
              </div>
            </div>
      ...
      getFreeSpace(id){
          axios.get(r("server.index"), {
              ...
              if (response.data.result){
                  this.FreeSpace=response.data.data
              }
