            ...
            <vs-tab label="Определение об отказе в КЖ/оставление без рассмотрения">
              <div class="vx-row" style="padding-top: 20px;">
                ...
                <div class="vx-col mb-2" style="margin-top: 15px">
                  <div class="vx-row">
                    <SudCopyRequest class="mt-1" :perem="'kas_opred_date'"></SudCopyRequest>
                    <vs-button class="mt-1" color="primary" style="margin-left: 10px" @click="showDatesKasOpredDate=!showDatesKasOpredDate">История</vs-button>
                    <vs-button class="mt-1" color="primary" style="margin-left: 10px">Файл</vs-button>
                    <SettingsRegSudAct class="mt-1" :perem="'kas_opred_date'" :type="'zapros'"></SettingsRegSudAct>
                  </div>
                </div>
              </div>
            </vs-tab>
          ...
          <vs-tabs alignment="fixed" color="danger">
            <vs-tab label="Решение суда КЖ">
              <div class="vx-row" style="padding-top: 20px;">
                ...
                <div class="vx-col mb-2" style="margin-top: 15px">
                  <div class="vx-row">
                    <SudCopyRequest class="mt-1" :perem="'kas_resh_sud_date'"></SudCopyRequest>
                    <vs-button class="mt-1" color="primary" style="margin-left: 10px" @click="showDatesKasReshSudDate=!showDatesKasReshSudDate">История</vs-button>
                    <vs-button class="mt-1" color="primary" style="margin-left: 10px">Файл</vs-button>
                    <SettingsRegSudAct class="mt-1" :perem="'kas_resh_sud_date'" :type="'zapros'"></SettingsRegSudAct>
                  </div>
                </div>
              </div>
              <div class="vx-row" style="padding-top: 20px;">
                <div class="vx-col mb-2">
                  <h6 class="h6 mb-2" style="margin-top: 10px;">Результат:</h6>
                  <VarToClipboard name="dcs_kas_resh_sud_success"/>
                  <vs-checkbox class="mt-1" v-model="Deb.debtorCreditSud.kas_resh_sud_success" @input="changeDebCredSud">
                    Удовлетворено
                  </vs-checkbox>
                  <VarToClipboard name="dcs_kas_resh_sud_success_chast"/>
                  <vs-checkbox class="mt-1" v-model="Deb.debtorCreditSud.kas_resh_sud_success_chast" @input="changeDebCredSud">
                    Удовлетворено частично
                  </vs-checkbox>
                  <VarToClipboard name="dcs_kas_resh_sud_cancel"/>
                  <vs-checkbox class="mt-1" v-model="Deb.debtorCreditSud.kas_resh_sud_cancel" @input="changeDebCredSud">
                    Отказано
                  </vs-checkbox>
                </div>
