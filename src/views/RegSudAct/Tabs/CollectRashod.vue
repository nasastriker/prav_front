    ...
    <div >
        <div class="mt-5">
          ...
          <vs-tabs alignment="fixed" color="danger">
            <vs-tab label="Заявление суд.расходы">
          <div class="vx-row" style="padding-top: 20px">
            <div class="vx-col sm:w-1/3 w-full mb-2">
              <h6 class="h6 mb-1">Дата регистрации заявления должника:<VarToClipboard name="dcs_clr_reg_zay_debtor_date"/></h6>
              <vs-input type="date" class="mb-4 w-100" v-model="Deb.debtorCreditSud.clr_reg_zay_debtor_date"  @blur="changeDebCredSud"></vs-input>

              <h6 class="h6 mb-1">Сумма судебных расходов:<VarToClipboard name="dcs_clr_sum"/></h6>
              <vs-input type="number" classmb-4 ="w-100" v-model="Deb.debtorCreditSud.clr_sum" @change="changeDebCredSud"></vs-input>
            </div>
            <div class="vx-col sm:w-1/3 w-full mb-2">
              <h6 class="h6 mb-1">Дата регистрации определения о назначении СЗ:<VarToClipboard name="dcs_clr_reg_opred_sz_date"/></h6>
              <vs-input type="date" class="mb-4 w-100" v-model="Deb.debtorCreditSud.clr_reg_opred_sz_date"  @blur="changeDebCredSud"></vs-input>
              <h6 class="h6 mb-1">Дата возражений на взыскание суд.расходов:<VarToClipboard name="dcs_clr_vozr_date"/></h6>
              <vs-input type="date" class="mb-4 w-100" v-model="Deb.debtorCreditSud.clr_vozr_date"  @blur="changeDebCredSud"></vs-input>
            </div>
          </div>
            </vs-tab>
          </vs-tabs>
          ...
          <vs-tabs alignment="fixed" color="danger">
            <vs-tab label="Определение суд.расходы">
          <div class="vx-row" style="padding-top: 20px">
            <div class="vx-col mb-2">
              <h6 class="h6">Определение суда о взыскании</h6>
              <h6 class="h6 mb-1">судебных расходов:<VarToClipboard name="dcs_clr_opred_sud_date"/></h6>
            ...
            <div class="vx-col mb-2" style="margin-top: 10px">
              <div class="vx-row">
                <SudCopyRequest class="mt-6" :perem="'clr_opred_sud_date'"></SudCopyRequest>
                <vs-button class="mt-6" color="primary" style="margin-left: 10px" @click="showDatesClrOpredSud=!showDatesClrOpredSud">История</vs-button>
                <vs-button class="mt-6" color="primary" style="margin-left: 10px">Файл</vs-button>
                <SettingsRegSudAct class="mt-6" :perem="'clr_opred_sud_date'" :type="'zapros'"></SettingsRegSudAct>
              </div>
            </div>
          </div>
            </vs-tab>
...
<!--          <h6 style="margin-top: 20px">Исполнение взыскания судебных расходов:</h6>-->

<!--          <div class="vx-row" style="padding-top: 10px;margin-left: 10px">-->
<!--            <div>-->
<!--              <h6 class="h6 mb-1">Сумма:<VarToClipboard name="dcs_clr_isp_sum"/></h6>-->
          ...
          <vs-tabs alignment="fixed" color="danger">
            <vs-tab label="Частная жалоба взыскание суд.расходы">
              ...
              <vs-checkbox v-model="Deb.debtorCreditSud.clr_claim_result_cancel" @input="changeDebCredSud">
                ...
                <div class="vx-col mb-2" style="margin-top: 10px">
                  <div class="vx-row">
                    <SudCopyRequest :perem="'clr_claim_napr_date'"></SudCopyRequest>
...
<!--                  <vs-input type="date" class="w-100" v-model="Deb.debtorCreditSud.clr_claim_napr_date"  @blur="changeDebCredSud"></vs-input>-->
...
<!--                <div class="vx-col sm:w-1/3 w-full mb-2">-->
<!--                  <h6 class="h6">Дата результата:<VarToClipboard name="dcs_clr_claim_result_date"/></h6>-->
<!--                  <vs-input type="date" class="w-100" v-model="Deb.debtorCreditSud.clr_claim_result_date"  @blur="changeDebCredSud"></vs-input>-->
...
<!--            </vs-tab>-->
<!--          </vs-tabs>-->
          <vs-popup class="holamundo" title="Дата результата:" :active.sync="showDatesClrOpredSud">
          ...
          <vs-popup class="holamundo" title="Дата результата:" :active.sync="showDatesClrClaim">
