        ...
        <fieldset class="f mt-4">
            ...
            <div class="vx-row">
                <div class="vx-col sm:w-6/12">
                    ...
                    <div class="centerx mb-3">
                        <vs-tooltip text="Оператор взаимодействия" position="top">
                            <h6 class="h6 mb-1">Оператор взаимодействия:</h6>
                        </vs-tooltip>
                        <v-select  class="w-50 " :reduce="label => label.id" label="name" :options="['Email сообщения', 'Sms сообщения', 'Автоинформатор (IVR)', 'Массовый обзвон', 'Обзвон оператором', 'Ответы на обращения должника']"  ></v-select>
                    </div>
                    ...
                    <div class="centerx">
                        <vs-tooltip text="Cправочник этапов стратегии – очередность видов взаимодействия и скриптов взаимодействия – проставляется в соответствии с применяемой стратегией: например Первичный звонок – значит идет обзвон по реестру без оператора" position="top">
                            <h6 class="h6 mb-1">Вид взаимодействия:</h6>
                        </vs-tooltip>
                    </div>
                    <vs-input class="w-100 mb-2" disabled value="Первичный звонок"></vs-input>
                   ...
                   <EtapStrategiiTable></EtapStrategiiTable>
...
<script>
    ...
    import EtapStrategiiTable from './EtapStrategiiTable.vue'
