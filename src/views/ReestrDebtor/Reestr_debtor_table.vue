<template>
    <div>
        <div class="vx-row" style="z-index: 222; position: relative; padding-top: 10px">
            
            <fieldset class="f ml-4">
                <legend class="l px-4">Поиск</legend>
                    <div class="vx-col w-full flex flex-wrap" style="justify-content: flex-start;">
                        <div class="mr-4">
                            <vs-input class="mb-4 md:mb-0 search_filter_input" v-model="credit.find" v-debounce:1500ms="updateSearchQuery" placeholder="ФИО..."/>
                        </div>
                        <div class="mr-4">
                            <vs-input class="mb-4 md:mb-0 search_filter_input" v-model="credit.find" v-debounce:1500ms="" placeholder="Номер договора..."/>
                        </div>
                        <div class="mr-4">
                            <vs-input class="mb-4 md:mb-0 search_filter_input" v-model="credit.find" v-debounce:1500ms="" placeholder="Номера телефона ..."/>
                        </div>
                ...
                <div class="mr-4 actionBtnWrapper" style="margin-top: 18px;">
                    <vs-dropdown>
                        ...
                        <vs-dropdown-menu>
                            ...
                            <vs-dropdown-item>
                                <vs-button class="mb-4 md:mb-0"  color="primary" style="width: 100%;right:0px" @click="sotrudnikSelectModal=true">Поставить задачу сотруднику</vs-button>
                            </vs-dropdown-item>
                            <vs-dropdown-item>
                            ...
                            <vs-dropdown-item>
                                <vs-button class="mb-4 md:mb-0"  color="primary" style="width: 100%;right:0px" @click="sendMailSelectModal=true">Отправить Email</vs-button>
                            </vs-dropdown-item>
                            <vs-dropdown-item>
                                <vs-button class="mb-4 md:mb-0"  color="primary" style="width: 100%;right:0px" @click="sendSmsSelectModal=true">Отправить SMS</vs-button>
                            </vs-dropdown-item>
                            <!--<vs-dropdown-item>
        ...
        <vs-popup  class="credit_dop_filter"  classContent="popup-example"  title="Дополнительные фильтры" :active.sync="filterPopup">
            ...
            <vs-popup classContent="selectModal" class="selectModalWrapper" title="Cмена оператора взаимодействия" :active.sync="operatorSelectModal">
                <div class="vx-row">
                    <div class="vx-col w-full">
                        ...
                        <v-select  class="w-50 mb-base" label="name" style="margin-bottom: 10px" ></v-select><!--40px-->
                    </div>
                </div>
                <div class="vx-row">
            ...
            <vs-popup classContent="selectModal" class="selectModalWrapper" title="Поставить задачу" :active.sync="sotrudnikSelectModal">
                <div class="vx-row">
                    <div class="vx-col w-full">
                        <h6 class="mb-1 h6">Выбрать сотрудника:</h6>
                        <v-select  class="w-50 mb-base mb-5" :options="['Иванов Иван Иванович']" label="worker" ></v-select>
                    </div>
                    <div class="vx-col w-full">
                        <h6 class="mb-1 h6">Должники:</h6>
                        <v-select  class="w-50 mb-base mb-5" :options="['Иванов Иван Иванович']" label="worker" ></v-select>
                    </div>
                    <div class="vx-col w-full">
                        <h6 class="mb-1 h6">Название задачи:</h6>
                        <vs-input class="w-full mb-base mb-5" type="text" ></vs-input>
                    </div>
                    <div class="vx-col w-full">
                        <h6 class="mb-1 h6">Описание задачи:</h6>
                        <vs-textarea class="w-100 mb-base"></vs-textarea>
                    </div>
                </div>
                <div class="vx-row">
                    ...
                    <div class="vx-col w-full text-center"><!-- w-1/2 text-right-->
                        <vs-button class="mt-6 ml-auto successBtn"  @click="sotrudnikSelectModal=false" color="success" type="filled">Добавить</vs-button>
                    </div>
                </div>
            </vs-popup>
    ...
    export default {
        ...
        methods: {
            ...
            onrowDoubleClicked(event){
                this.$router.push('/test_debtor/'+event.data.id)
            },
