        ...
        <div class="vx-card p-6">
            <div class="flex flex-wrap justify-between items-center">
                <div class="mb-4 md:mb-0 mr-4 ag-grid-table-actions-left">
                    <vs-dropdown vs-trigger-click class="cursor-pointer">
                        <div class="cursor-pointer flex items-center justify-between font-medium mr-4" style="padding: 0.75rem !important;margin-top: 0px;border: 1px solid #ccc;border-radius: 4px;height: 38px;">
                            <span class="mr-2">{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ TotalUsers - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : TotalUsers }} of {{ TotalUsers }}</span>
                ...
                <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
                    ...
                    <vs-button color="success" class="pull-right" type="filled"  @click="newUser">Новый пользователь</vs-button>
                </div>
            </div>
            <ag-grid-vue
                    ref="agGridTable"
...
export default {
  ...
  computed: {
    totalPages () {
      ...
      if (this.gridApi) return Math.ceil(this.TotalUsers / this.paginationPageSize)
      else return 0
    },
    paginationPageSize () {
    ...
    ...mapGetters(['UsersArr', 'TotalUsers']),
    currentPage: {
      get () {
  ...
  methods: {
    ...
    newUser () {
      this.$router.push('/adm/users/new')
    },
