        ...
        <div class="mt-5">
                ...
                <vs-popup classContent="popup-example" title="Тип документа" :active.sync="popupActive2">
                    <div class="mt-8 mb-base">
                        ...
                        <div class="mt-2">
                            <v-select  class="w-50 " :reduce="label => label" label="name" :options="OrgnDcDocumentsRec"  v-model="typeDoc"  ></v-select>
                ...
                <ag-grid-vue
                        ...
                        class="ag-theme-material w-100 my-4 ag-grid-table vh72"
                        :columnDefs="columnDefs"
                        :defaultColDef="defaultColDef"
                        :rowData="OrgnDocumentsArr"
...
<script>
    ...
    import Open from './Render/OpenOrgnDocument.vue'
    ...
    export default {
        ...
        mounted(){
          ...
          this.getDataOrgnDocuments(this.id)
        },
        ...
        computed: {
            ...
            totalPages () {
                ...
                if (this.gridApi)
                    return Math.ceil(this.TotalOrgnDocuments / this.paginationPageSize)
                else return 0
            },
            paginationPageSize () {
            ...
            ...mapGetters([
               'OrgnDocumentsArr','TotalOrgnDocuments','User','OrgnDcDocumentsRec'
        ...
        methods: {
            ...
            findType(type){
                for (let  i = 0; i < this.OrgnDcDocumentsRec.lenght; i++) {
                    if(this.OrgnDcDocumentsRec[i].id==type){
                        return this.OrgnDcDocumentsRec[i].type_document
                    }
            ...
            ...mapActions([
                'getDataOrgnDocuments','getTypesDcDocuments','saveOrgnDocument'
            ]),
