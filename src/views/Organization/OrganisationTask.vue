<template>
        <div class="mt-5">
                ...
                <vs-checkbox style="margin-top: 10px" v-model="data.taskAll" @input="saveLoc">Задачи по умолчанию</vs-checkbox>
              ...
              <div class="vx-row" style="margin-top: 20px">
                ...
                <div class="vx-col mb-2">
                  <vs-checkbox v-model="data.stadia_sud" @input="saveLoc">Приказное производство</vs-checkbox>
                  <vs-checkbox v-model="data.stadia_dublicat" @input="saveLoc">Дубликат ИД</vs-checkbox>
                </div>
              </div>
...
<script>
    ...
    import Open from '../Recoverer/Render/OpenRecoverTask.vue'
    import OpenActive from '../Recoverer/Render/OpenActive.vue'
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters([
               'RecoverTasksArr','TotalRecoverTasks','User','RecoverTaskArrAllFind'
        ...
        methods: {
            ...
            newTask(){
                this.$router.push('/recoverer_task/new?org='+this.$route.params.id)
            },
