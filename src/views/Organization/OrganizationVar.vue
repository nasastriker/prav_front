...
<script>
    ...
    import OrganizationVarOpenLink from './Render/OrganizationVarOpenLink.vue'
    ...
    export default {
            ...
            return {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        filter: true,
                        width: 50,
                        cellRendererFramework: 'OrganizationVarOpenLink',
                        cellRendererParams: {
        ...
        methods: {
            ...
            saveImage(evt){
                ...
                formData.append('id_orgn', this.$route.params.id)
                formData.append('id_recover', 0)
               ...
               this.$vs.loading({ color: '#ff8000' })
                axios.post(r('organizationVar.update'), {
                    ...
                    if(res.data.result){
                        ...
                        this.getDataOrganizationVar({id_orgn:this.$route.params.id,id_recover:0});
            ...
            saveField(){
                this.organizationFieldEdit.id_orgn=this.$route.params.id
                this.organizationFieldEdit.id_recover=0
                this.$vs.loading({ color: '#ff8000' })
