        ...
        <div class="mt-5">
            ...
            <vs-tabs>
                <vs-tab label="Основные">
                    ...
                    <vs-input class="w-full mb-base" label-placeholder="Номер договора" v-model="data.number"></vs-input>

                    <vs-input type="date" class="w-full mb-base" label-placeholder="Дата договора" v-model="data.date"></vs-input>

                    <vs-input class="w-full mb-base" label-placeholder="Цедент" v-model="data.name"></vs-input>

                    <label style="margin-bottom: 10px">Адрес </label>
                    <VueSuggestions
                    ...
                    <vs-input class="w-full mb-base" label-placeholder="ОГРН" v-model="data.ogrn"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="ИНН" v-model="data.inn"></vs-input>
                    <label style="margin-bottom: 10px">Примечание: </label>
                    <vs-textarea v-model="data.prim" />


                </vs-tab>
                <vs-tab label="Банковские реквизиты">

                    <vs-input class="w-full mb-base" label-placeholder="Бик Банка" v-model="data.bic"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="Банк" v-model="data.bank"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="Р/с" v-model="data.account"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="К/с " v-model="data.ks"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="ИНН получателя платежа " v-model="data.inn_payee"></vs-input>
                    <vs-input class="w-full mb-base" label-placeholder="Получатель платежа " v-model="data.payee"></vs-input>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters([
                'OrganizationListFilterArr','SuggestionOptionsAddress'
            ]),
