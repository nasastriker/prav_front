<template>
    <div >
        ...
        <span title="Скачать в формате XLSX" class="mr-2">
            <svg  version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" @click="downloadDocumentXls" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 512 512" style="  max-height: 20px;cursor: pointer;enable-background:new 0 0 512 512;" xml:space="preserve">
            <path style="fill:#507C5C;" d="M438.557,512H19.785c-8.216,0-14.876-6.66-14.876-14.876V256.916c0-8.216,6.66-14.876,14.876-14.876
                ...
                C453.433,505.34,446.772,512,438.557,512z"/>
                    ...
                    c-1.761,0-3.413-0.55-4.073-1.761L255.692,313.875z"/>
                            <path style="fill:#507C5C;" d="M301.595,342.277c-3.744,0-7.487-1.761-7.487-5.284v-70.017c0-3.633,4.295-5.174,8.586-5.174
        ...
        <span title="Скачать в формате PDF" class="mr-2">
            <feather-icon style="margin-left: 8px" icon="DownloadCloudIcon" svgClasses="h-5 w-5 mr-4 hover:text-primary cursor-pointer" @click="downloadDocument" />
        </span>
