<template>
    <div>
        <h6><b>Блок текста с ФИО:</b></h6>
        [ {{ dataItem.special_data.fio_data.block_fio }} ]
        <br>
        <br>
        <h6><b>Блок текста с Определением:</b></h6>
        [ {{ dataItem.special_data.opred_data.block_opred }} ]
        <br>
        <br>
        <h6><b>ОПРЕДЕЛЕНИЕ: {{ dataItem.special_data.opred_data.opred }} </b></h6>
        <br>
        ...
        <div v-if="show_all_info">
            ...
            <div class="all_info_file">
                ...
                <div class="all_info_file_smaller">
                    <b>Попытка 1:</b>
                    [ {{ dataItem.special_data.fio_data.first_res }} ]
                    <br>
                    <b>Попытка 2:</b>
                    [ {{ dataItem.special_data.fio_data.second_res }} ]
                    <br>
                    <b>Результат:</b>
