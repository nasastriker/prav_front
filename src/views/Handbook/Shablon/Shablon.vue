        ...
        <div class="vx-card p-6">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
                    ...
                    <vs-button color="success" class="pull-right" type="filled"  @click="$router.push('/shablon/new')">Новый шаблон</vs-button>
                </div>
            </div>
            <ag-grid-vue
                    ref="agGridTable"
                    ...
                    :rowData="ShablonDocumentsArrNotRec"
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters([
                'ShablonDocumentsArrNotRec','TotalShablonDocuments'
        ...
        methods: {
            ...
            onrowDoubleClicked(event){
                this.$router.push('/shablon/'+event.data.id)
            },
            ...mapActions([
