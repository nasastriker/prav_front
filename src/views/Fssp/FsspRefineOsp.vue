    ...
    <div id="page-user-list">
        <div class="vx-card p-6">
            <div class="flex flex-wrap justify-between items-center">
                ...
                <div class="flex flex-wrap items-center justify-between ag-grid-table-actions-right">
                    ...
                    <span style="max-width: 40px;">
                            <img src="/loading.gif" v-if="FsspRefineLoadingFlag" style="max-width: 40px; margin-top: 5px;">
                            </span>
                </div>
            </div>
            ...
            <div class="out-main">
                ...
                <div class="tablePreloader outer-div" v-if="FsspRefineLoadingFlag">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapGetters([
                'DebtorRefinesArr','TotalDebtorRefines','StatussArr','User','StatussDebtorArrAndAll','RegionArr','FsspRefineLoadingFlag'
        ...
        methods: {
            ...
            onrowDoubleClicked(event){
                    ...
                    this.$router.push('/fssp_refine_osp/'+event.data.id)
        ...
        mounted () {
            ...
            this.User.pag.fssp_refine.status=102
            this.getDataDebtorRefines(this.User.pag.fssp_refine);
