<template>
    <vx-card no-shadow class="debtorContacts">
                ...
                <fieldset class="f mt-4">
                    <div class="vx-row">
                        ...
                        <div class="vx-col w-1/2">
                            ...
                            <div><vs-button color="primary" type="line" ><feather-icon icon="PhoneOutgoingIcon" class="mr-4" svgClasses="h-6 w-6" /> Начать звонок</vs-button></div>
                            ...
                            <div><vs-button color="primary" type="line" @click="promiseModal=true"><feather-icon icon="FolderPlusIcon" class="mr-4" svgClasses="h-6 w-6" /> Добавить обещание платежа</vs-button></div>
                            <div><vs-button color="primary" type="line" @click="scheduleCallModal=true"><feather-icon icon="PhoneIcon" class="mr-4" svgClasses="h-6 w-6" /> Запланировать звонок</vs-button></div>
                            ...
                            <div class="vx-row mt-6">
                                <div class="vx-col w-full">
                                    <vs-button @click="resultCallModal=true" style="width:200px;" color="danger" class="mt-3 mr-4 mb-4">Окончить звонок</vs-button>
                    ...
                    <div class="vx-row">
                        <div class="vx-col w-full">
                            <vs-tabs >
                                <vs-tab label="Справочник скриптов">
                                    <ScriptDirectory></ScriptDirectory>
                                </vs-tab>
                                <vs-tab label="Рекомендации стратегии переговоров">
        ...
        <vs-popup classContent="selectModal" class="selectModalWrapper" title="Запланировать звонок" :active.sync="scheduleCallModal">
            <div class="vx-row">
                <div class="vx-col w-full">
                    <h6 class="mb-1 h6">Запланировать повторный звонок:</h6>
                    <vs-input class="w-100 datepicker mb-4" type="date"></vs-input>
                </div>
            </div>
            <div class="vx-row">
                <div class="vx-col w-full text-right">
                    <vs-button class="mt-6 ml-auto successBtn"  @click="scheduleCallModal=false" color="success" type="filled">Сохранить</vs-button>
                </div>
            </div>
        </vs-popup>

        <vs-popup classContent="selectModal" class="selectModalWrapper" title="Результат звонка" :active.sync="resultCallModal">
            <div class="vx-row">
                <div class="vx-col w-full">
                    <h6 class="mb-1 h6">Выбрать результат звонка:</h6>
                    <v-select  class="w-50 mb-4" label="name" style="margin-bottom: 40px" ></v-select>
                </div>
            </div>
            <div class="vx-row">
                <div class="vx-col w-full text-right">
                    <vs-button class="mt-6 ml-auto successBtn"  @click="resultCallModal=false" color="success" type="filled">Сохранить</vs-button>
                </div>
            </div>
        </vs-popup>
...
<script>
    ...
    import ScriptDirectory from './ReestrDebtorTab/ScriptDirectory.vue';
    import Recomendation from './ReestrDebtorTab/Recomendation.vue';
