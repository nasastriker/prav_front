...
<script>
    ...
    import StatusBkiCredit from './../../BKI/Render/StatusBkiCredit.vue'
    ...
    export default {
        ...
        mounted() {
            ...
            this.getBkiJournalOnce(this.Deb.debtorCredit.id)
