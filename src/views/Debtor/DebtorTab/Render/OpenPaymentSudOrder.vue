<template>
    <div >
        ...
        <vs-popup classContent="popup-example" title="Информация по платежу по суд расходам" :active.sync="popupActiveInfoPaymentSudOrder">
...
<script>
    ...
    export default {
        ...
        data () {
            return {
                popupActiveInfoPaymentSudOrder: false,
                reestr_info: {}
            }
        },
        methods: {
            ...
            showInfoPayment(){
                this.getInfoPaymentSo(this.params.value).then((response)=> {
                    if (response.result){
                        this.reestr_info = response.reestr;
                        this.popupActiveInfoPaymentSudOrder = true;
                    }
                });
            },
            confirmDeleteRecord () {
            ...
            deleteRecord () {
                ...
                this.delPaymentSoOne(this.params.value).then((value)=> {
                  if(value){
