<template>
    <div id="page-user-list">
        ...
        <vs-popup style="min-height: 500px;" classContent="popup-example" title="Изменение поля" :active.sync="popupActive">
                ...
                <vs-input class="w-full mb-base"  v-model="fieldNow"></vs-input>

          <h6 class="h6" style="margin-top: 7px;margin-bottom: 7px">Описание:</h6>
          <vs-input class="w-full mb-base"  v-model="fieldDescription"></vs-input>

                <h6 class="h6" style="margin-top: 7px;margin-bottom: 7px">Тип поля:</h6>
                <v-select  class="w-50"  style="margin-top: 15px" :options="peremenArrType"  v-model="typeFieldInput"  ></v-select>

                <h6 class="h6" style="margin-top: 7px;margin-bottom: 7px">Номер:</h6>
                <vs-input type="number"  class="w-50"  v-model="fieldNowNumber"></vs-input>
    ...
    export default {
        ...
        data () {
            return {
                ...
                popupActive:false,
                peremenArrType:[
                    'boolean','integer','date','string','text','decimal','array'
                ],
                peremenArr:[],
                fieldNowUsl:0,
                fieldNowId:0,
        ...
        methods: {
            ...
            checkChange(){
              ...
              if(this.fieldNow.type==='array'){
                this.typeFieldInput='array'
                return 'array'
              }
            },
            deleteUsl(data){
                for (let i = 0; i < this.peremenArr.length; i++) {
                    if(data.peremen==this.peremenArr[i].peremen&&data.value==this.peremenArr[i].value){
            ...
            editUsl(data){
               ...
               this.fieldDescription=data.description
            ...
            addUsl(){
              console.log(this.typeFieldInput)
                this.popupActive=false
                this.peremenArr.push(
                    {
                        id:this.fieldNowId,
                        peremen:this.fieldNow,
                        number:this.fieldNowNumber,
                        type:this.typeFieldInput,
