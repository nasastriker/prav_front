    ...
    <div id="page-user-list">
        ...
        <div class="vx-row" style="padding-top: 5px">
            <div class="vx-col sm:w-1/6 w-full mb-2">
              ...
              <div><span style="color:red;font-size: 6pt">После ввода нажмите Enter</span></div>
            </div>
            <div class="vx-col sm:w-1/6 w-full mb-2">
            ...
            <!--<div class="vx-col sm:w-1/6 w-full mb-2">
                <h6 class="h6Blue">№ дела Иск:</h6>
                <vs-input class="w-full" style="max-width: 350px"  v-model="number_delo_il"  @keyup.enter="findNumberDeloIl" ></vs-input>
...
<script>
    ...
    export default {
        components: {
            'v-select': vSelect,Status,AgGridVue,SpinnerLoader,Regmail,BankAnswer,FnsAnswer,FsspAnswer,DebtorID,OpenCreditStatus
        },
        data () {
            return {
                inputField:0,
