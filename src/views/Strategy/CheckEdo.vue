<template>
    <vx-card no-shadow style="min-height: 95vh;">
        ...
        <div >
            <vs-checkbox style="margin-top: 15px" v-model="data.checkFns" >Использова ФНС</vs-checkbox>

        </div>
        <template v-if="data.checkFns==0">
            <div >
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions([
                ...
                'getTemplSoftsEmail','getTemplSoftsVoice','getTemplSoftsSms','getDataStatuss','getDataFuncFnss'
            ]),
            add(){
