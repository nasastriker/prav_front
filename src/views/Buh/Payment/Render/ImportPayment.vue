      ...
      <vs-popup style="min-height: 500px;" classContent="popup-example" title="Выберите взыскателя или договор цессии" :active.sync="popupActive2">
          ...
          <div class="vx-row">
              <div class="vx-col sm:w-1/2 w-full mb-2">
                ...
                <vs-checkbox  v-model="import_obr3" >Импорт образец 3</vs-checkbox>
              </div>
              <div class="vx-col sm:w-1/2 w-full mb-2">
                  <a v-auth-href  href="/example_file/?filename=type_pay" >Образец импорта </a> <br>
                  <a v-auth-href  href="/example_file/?filename=type_pay_1c" >Образец импорта из 1с</a><br>
                  <a v-auth-href  href="/example_file/?filename=type_pay_obr_1c" >Образец импорта 2</a><br>
                  <a v-auth-href  href="/example_file/?filename=type_pay_obr_3" >Образец импорта 3</a>
              </div>
...
export default {
  ...
  methods: {
      checkProblem(){
          ...
          axios.post(r("payment.index"), {
              ...
              if (response.data.result){
                  ...
                  this.$vs.notify({  title:'Сообщение', text: 'Задача запущенна!!!', color: 'success', position: 'top-center' })
      ...
      ...mapActions([
          'getDataReestrsAndPrav','getDataReestrsPayment','savePaymentFile','getVidRecoverInDebtorCreditArr'
      ]),
      saveDocument(evt){
          this.$vs.loading({color: '#ff8000'})
          this.savePaymentFile({
              file: evt.target.files,
              import_type:this.import_type,
              import_obr3:this.import_obr3 ,
